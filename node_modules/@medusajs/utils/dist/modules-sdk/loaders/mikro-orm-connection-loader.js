...
function mikroOrmConnectionLoader(_a) {
    var _b, _c;
    var container = _a.container, options = _a.options, moduleDeclaration = _a.moduleDeclaration, entities = _a.entities;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, loadShared({ container: container, entities: entities })];
...
function loadDefault(_a) {
    var database = _a.database, entities = _a.entities;
    return __awaiter(this, void 0, void 0, function () {
        var orm;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, dal_1.mikroOrmCreateConnection)(database, entities)];
                case 1:
                    orm = _b.sent();
...
function loadShared(_a) {
    var container = _a.container, entities = _a.entities;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!sharedConnection) {
                        throw new Error("The module is setup to use a shared resources but no shared connection is present. A new connection will be created");
                    }
